...
class AesopAPI:
    ...
    def games_api_create_game(self, request: components.GameSchemaIn) -> operations.GamesAPICreateGameResponse:
        ...
        res = operations.GamesAPICreateGameResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def games_api_list_games(self) -> operations.GamesAPIListGamesResponse:
        ...
        res = operations.GamesAPIListGamesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def stories_api_list_stories(self) -> operations.StoriesAPIListStoriesResponse:
        ...
        res = operations.StoriesAPIListStoriesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
